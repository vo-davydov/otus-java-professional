...
public class UsersWebServerSimple implements UsersWebServer {
    ...
    private Server initContext() {
        ...
        handlers.addHandler(applySecurity(servletContextHandler, "/users", "/api/user/*", "/admin", "/api/admin/*"));
    ...
    private ServletContextHandler createServletContextHandler() {
        ...
        servletContextHandler.addServlet(new ServletHolder(new AdminApiServlet(userDao, gson)), "/api/admin/*");
